...
const adminRightSide = () => {
    return(
        <div className="card mb-4">
            ...
            <ul className="list-group">
                <li className="list-group-item">
                    <span className="label label-primary mr-2">Name:</span>{name}

                </li>
                <li className="list-group-item">
                    <span className="label label-primary mr-2">Email:</span>{email}

                </li>
                <li className="list-group-item">
                    <span className="label label-secondary mr-2">Admin Area</span>
